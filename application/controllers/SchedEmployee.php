        ...
        switch ($txn) {
            ...
            case 'timein':
                ...
                if(count($schedule_employee_id_temp)!=0){
                    ...
                    //   if($ot_in==null || $ot_in=="0000-00-00 00:00:00"){
                    //     $m_schedule->ot_in = $date.' '.date("H:i:s");
                    //     $m_schedule->modify($schedule_employee_id);
                    //     $response['title']='Success';
                    //     $response['stat']='success';
                    //     $response['msg']='Overtime IN Successful.';
                    //     echo json_encode($response);
                    //     exit();
                    //   }
                    //   if( ($ot_out!=null || $ot_out!="0000-00-00 00:00:00") && ($ot_out==null || $ot_out=="0000-00-00 00:00:00") ){
