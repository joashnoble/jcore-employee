        ...
        switch($payrollreports){
            ...
            $pay_period_id = $filter_value;
              ...
              $data['emp_sched_report']=$this->SchedEmployee_model->get_list(
                ...
                $file_name=$data['emp_info'][0]->full_name." (Schedule - ".$data['payperiod'][0]->pay_period.")";
                $pdfFilePath = $file_name.".pdf"; //generate filename base on id
                $pdf = $this->m_pdf->load(); //pass the instance of the mpdf class
                $content=$this->load->view('template/employee_schedule_report_html',$data,TRUE); //load the template
                $pdf->WriteHTML($content);
                //download it.
                $pdf->Output($pdfFilePath,"D");
