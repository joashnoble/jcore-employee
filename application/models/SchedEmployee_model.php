...
class SchedEmployee_model extends CORE_Model {
    ...
    function getschedules($employee_id,$pay_period_id) {
      	$query = $this->db->query("SELECT
                                      schedule_employee.*,
                                      DATE_FORMAT(schedule_employee.date, '%m/%d/%Y') as date,
                                      ...
                                      END) AS daytype,
                                      DATE_FORMAT(schedule_employee.time_in, '%h:%i %p') as time_in,
                                      DATE_FORMAT(schedule_employee.time_out, '%h:%i %p') as time_out,
